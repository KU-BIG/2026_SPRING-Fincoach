...
처음 안: "PR 100-300줄 강제 + 단독 머지". 팀원이 LLM에게 PR 짜라고 시키므로 사람 기준 룰은 friction만 만든다. 단독 머지는 학습용 프로젝트에 과한 게이트킵.
...
- [x] GitHub UI에서 branch protection 룰 설정 (admin 권한 필요)
