          ...
          <div className="body">
            <section>
              ...
              <p>
                ...
                1년치 이익의 몇 배에 거래되는지 나타냅니다. 예: 주가 70,000원 / EPS 5,000원 = PER
                14배 — 현재 이익 기준으로 투자금을 회수하는 데 14년이 걸린다는 의미입니다.
              </p>
            </section>
            <section>
              <h3>현재 시장 흐름</h3>
              <p>
                코스피 평균 PER은 약 10~12배 수준입니다. 반도체주는 이익 변동성이 크기 때문에 단일
                연도 PER보다 <b>정상화 이익 기준 PER(Normalized PER)</b>을 더 많이 참고합니다. 동종
                업계 평균 PER과 비교하는 상대 가치 접근이 합리적입니다.
              </p>
            </section>
            <section>
              <h3>포트폴리오 적용</h3>
              <p>
                PER만 보지 말고 <b>ROE·EPS 성장률</b>과 함께 해석해야 합니다. 성장주는 높은 PER이
                정당화될 수 있고, 가치주는 낮은 PER이 함정일 수도 있습니다(이익의 질 저하). PER을 EPS
                성장률로 나눈 PEG 지표도 함께 참고하세요.
              </p>
            </section>
          </div>
